...
#==============================================================================
climateNA <- raster::brick("data-raw/climateNA.grd")
climateNA_coarse <- raster::aggregate(climateNA, 4, expand)
...
ghcnd_stations_climate <- dplyr::bind_cols(as.data.frame(stations), as.data.frame(temper[, -1]))

tester <- read.csv("data-raw/ghcnd_climate.csv")

all.equal(tester$TD, meta_final_final$TD)

write.csv(meta_final_final, file = "data-raw/meta_final_gridded.csv", row.names = FALSE)
#==============================================================================
